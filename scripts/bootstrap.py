...
AV_CONFIG_BASENAMES = {av["name"]: f"{av['name']}.yaml" for av in SEED_AV_TEMPLATES}
SIM_CONFIG_BASENAMES = {sim["name"]: f"{sim['name']}.yaml" for sim in SEED_SIMULATOR_TEMPLATES}
